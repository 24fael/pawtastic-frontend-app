                ...
                <div className="col-12 col-md-6 mt-5 mt-md-0">
                    <div className="row">
                        <div className="col col-md-6" id='muffin'>
                            <img src={Muffin} className="m-3 img-fluid image-hover-zoom" alt="Muffin"/>
                        </div>
                        <div className="col col-md-6" id='peep'>
                            <img src={Peep} className="m-3 img-fluid image-hover-zoom" alt="Peep"/>
                        </div>
                        <div className="col col-md-6" id='natasha'>
                            <img src={Natasha} className="m-3 img-fluid image-hover-zoom" alt="Natasha"/>
                        </div>
                        <div className="col col-md-6" id='marlon'>
                            <img src={Marlon} className="m-3 img-fluid image-hover-zoom" alt="Marlon"/>
                        </div>
                    </div>
                </div>
            </div>
