        ...
        <section id="banner">
            <div className='container p-5'>
                <div className='d-flex justify-content-between align-items-center'>
                    <div>
                        <h3>
                            <a href="#" className='text-decoration-none text-white'><img src={Logo} alt="Logo" /> PAWTASTIC</a>
                        </h3>
                    </div>
                    <div>
                ...
                <div className='row mt-3'>
                    <div className="col-4 offset-8">
                        ...
                        <button className='mt-5 btn btn-light rounded-5 py-2 px-5' id='schedule-button-primary'>
                            Schedule a visit
                        </button>
                    </div>
                </div>
